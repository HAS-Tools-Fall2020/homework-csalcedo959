...
a2 = aa.twinx()
a2.plot(stream_data.loc['2017':'2020'].index.values, stream_data['flow']
        ['2017':'2020'], color='green', alpha=0.7, linewidth=0.2,
        label='Streamflow')
...
bb.legend(loc='lower left',
          bbox_to_anchor=(.5, -0.3), ncol=5)
b2 = bb.twinx()
b2.plot(stream_data.loc['2017':'2020'].index.values, stream_data['flow']
        ['2017':'2020'], color='green', alpha=0.7, linewidth=0.2,
        label='Streamflow')
...
cc.legend(loc='lower left',
          bbox_to_anchor=(.5, -0.3), ncol=5)
c2 = cc.twinx()
c2.plot(stream_data.loc['2017':'2020'].index.values, stream_data['flow']
        ['2017':'2020'], color='green', alpha=0.7, linewidth=0.2,
        label='Streamflow')
...
corr_precip_rate = stream_data['flow']['2009-01-01':'2020-11-01'].corr(
    precip_df['prate']['2009-01-01':'2020-11-01'])
print('Correlation with Precipitation Rate:', corr_precip_rate)

# Plot the correlation
fig, ax = plt.subplots()
ax.scatter(stream_data['flow']['2009-01-01':'2020-11-01'],
           precip_df['prate']['2009-01-01':'2020-11-01'],
           color='blue', marker='*')
ax.set_xlim([0, 5000])
ax.set_title(
